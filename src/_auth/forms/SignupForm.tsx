...
import { useCreateUserAccount, useSignAccount } from "@/lib/appwrite/react_query/queriesAndMutations";
    ...
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        <img src="/assets/images/logo.svg" alt="logo"/>
          ...
          account</h2>
          <p className="text-light-3 small-medium md:base-regular mt-2">To 
          use Snapgram enter your details</p>
